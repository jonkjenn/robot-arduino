...
#define TIMEOUT       2500  // waits for 2500 microseconds for sensor outputs to go low
        ...
        double out_consKp=0.024, out_consKi=0.0, out_consKd=0.0, out_pid_weight = 1.0;
        double inn_pid_SetPoint,inn_pid_Input,inn_pid_Output;
        double inn_consKp=3.0, inn_consKi=0.0, inn_consKd=0.0, inn_pid_weight = 1.0;
        PID *outerPID;
        PID *innerPID;
        ...
        public:
            ...
            void setup(Servo *ST1,Servo *ST2);
};
